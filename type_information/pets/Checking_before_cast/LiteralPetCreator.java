...
public class LiteralPetCreator extends PetCreator {
    ...
    public static final List<Class<? extends IndividualPet>> all_types = Collections.unmodifiableList(Arrays.asList(IndividualPet.class, Dog.class,Cat.class, Pugg.class, Mutt.class,CatEgyptianMau.class, CatManx.class, CatManxCymric.class, Ret.class, Mouse.class));
